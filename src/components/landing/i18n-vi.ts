...
export const vi: Copy = {
  ...
  hero: {
    ...
    headAfter: "",
    subcopy:
      "TradeIt giúp các doanh nghiệp xuất khẩu, nhà sản xuất và đội ngũ bán hàng quốc tế tìm kiếm người mua nhanh hơn nhờ dữ liệu thương mại toàn cầu và AI. Giới thiệu TradeIt đến những doanh nghiệp phù hợp và nhận hoa hồng định kỳ hằng tháng.",
    seeRewards: "Xem cách tính hoa hồng",
    freeToJoin: "Tham gia miễn phí",
    commissions: "Hoa hồng 15% + 5%",
    trustLabel: "Được các chuyên gia thương mại quốc tế tin dùng",
    trustItems: [
  ...
  why: {
    ...
    cards: [
      {
        title: "Giúp doanh nghiệp phát triển ra thị trường toàn cầu",
        body: "Giới thiệu cho doanh nghiệp một cách nhanh hơn để tìm kiếm người mua đáng tin cậy thông qua dữ liệu thương mại toàn cầu và công cụ bán hàng được hỗ trợ bởi AI.",
      },
      {
        title: "Khách hàng phát triển, thu nhập của bạn cũng tăng theo",
        body: "Khi khách hàng bạn giới thiệu tiếp tục sử dụng TradeIt, bạn có thể nhận hoa hồng định kỳ hằng tháng.",
      },
      {
    ...
    people: [
      {
        ...
        body: "Giới thiệu TradeIt cho các doanh nghiệp bạn đang tư vấn như một công cụ thiết thực để nâng cao hiệu quả bán hàng quốc tế.",
      },
      {
        title: "Nhà sáng tạo nội dung",
        body: "Chia sẻ một công cụ hữu ích với cộng đồng của bạn và tạo nguồn thu định kỳ.",
      },
      {
        title: "Hiệp hội thương mại và ngành hàng",
        body: "Mang đến cho hội viên một giải pháp thực tế có thể sử dụng ngay để phát triển bán hàng quốc tế.",
      },
      {
        title: "Cộng đồng và mạng xã hội",
        body: "Chia sẻ với cộng đồng của bạn những công cụ và thông tin hữu ích giúp doanh nghiệp tăng trưởng thực sự.",
      },
      {
        title: "Nhà tiếp thị liên kết",
        body: "Quảng bá một sản phẩm B2B SaaS có nhu cầu rõ ràng trên thị trường và xây dựng nguồn thu ổn định hơn.",
      },
    ],
  },
  promote: {
    eyebrow: "Bạn sẽ giới thiệu điều gì",
    title: "Giới thiệu giải pháp mà doanh nghiệp thực sự cần",
    subtitle:
      "Giúp doanh nghiệp tìm kiếm người mua đã được xác thực, bổ sung dữ liệu công ty và liên hệ, đồng thời quản lý bán hàng quốc tế trên cùng một nền tảng.",
    features: [
      {
        title: "Tìm kiếm dữ liệu thương mại B/L",
        body: "Tìm kiếm trong hàng tỷ bản ghi vận đơn để xác định các nhà nhập khẩu và xuất khẩu đang hoạt động thực tế.",
      },
      {
        title: "Bổ sung dữ liệu người mua",
        body: "Bổ sung thông tin công ty, liên hệ của người ra quyết định và dữ liệu doanh nghiệp quan trọng để xây dựng danh sách người mua chính xác hơn.",
      },
      {
        title: "Phân tích người mua bằng AI",
        body: "AI giúp phân tích mức độ phù hợp của từng người mua và ưu tiên những khách hàng tiềm năng có khả năng chuyển đổi cao hơn.",
      },
      {
        title: "CRM",
        body: "Quản lý việc tìm kiếm người mua, cơ hội bán hàng và từng giai đoạn trong pipeline trên một không gian làm việc duy nhất.",
      },
      {
        title: "Tích hợp email",
        body: "Liên hệ trực tiếp với người ra quyết định và theo dõi lịch sử gửi email, phản hồi cũng như các hoạt động outreach.",
      },
    ],
  },
  rewards: {
    ...
    items: [
      {
        ...
        context: "Nhà sản xuất thực phẩm",
        quote:
          "Trước đây, chúng tôi mất nhiều ngày để tìm được người mua đáng tin cậy. Với TradeIt, chúng tôi có thể xác định khách hàng tiềm năng phù hợp chỉ trong vài phút.",
      },
      {
        role: "Quản lý bán hàng quốc tế",
        context: "Thiết bị công nghiệp",
        quote:
          "Tính năng bổ sung dữ liệu người mua giúp chúng tôi tiếp cận đúng người ra quyết định, thay vì chỉ gửi email đến địa chỉ chung của công ty.",
      },
      {
        role: "Chuyên gia tư vấn doanh nghiệp",
        context: "Cố vấn độc lập",
        quote:
          "TradeIt rất dễ giới thiệu vì khách hàng nhanh chóng hiểu được giá trị của nền tảng này.",
      },
      {
        role: "Nhà sáng tạo nội dung",
        context: "Kênh tăng trưởng B2B",
        quote:
          "Cộng đồng của tôi luôn tìm kiếm các công cụ bán hàng quốc tế thực tế. TradeIt đã trở thành một trong những giải pháp tôi thường xuyên giới thiệu nhất.",
      },
      {
        role: "Trưởng nhóm sourcing",
        context: "Hàng tiêu dùng",
        quote:
          "TradeIt giúp chúng tôi hiểu ai đang mua, ai đang cung cấp và cơ hội mới đang xuất hiện ở đâu.",
      },
      {
        role: "Nhà tiếp thị liên kết",
        context: "Hợp tác SaaS",
        quote:
          "Cơ chế hoa hồng định kỳ khiến TradeIt hấp dẫn hơn nhiều so với các chương trình giới thiệu trả thưởng một lần.",
      },
      {
        role: "Đội ngũ bán hàng quốc tế",
        context: "Sản xuất",
        quote:
          "Chúng tôi có thể quản lý việc tìm kiếm người mua, bổ sung dữ liệu liên hệ và outreach trong cùng một quy trình thay vì phải chuyển đổi giữa nhiều công cụ.",
      },
      {
        role: "Quản lý hiệp hội thương mại",
        context: "Quyền lợi hội viên",
        quote:
          "TradeIt mang đến cho hội viên một cách thực tế để khám phá thị trường toàn cầu thông qua dữ liệu thương mại thực.",
      },
      {
        role: "Quản lý mua hàng",
        context: "Doanh nghiệp nhập khẩu",
        quote:
          "TradeIt giúp chúng tôi có cái nhìn về nhà cung cấp toàn cầu và mối quan hệ thương mại mà khó tìm thấy ở nơi khác.",
      },
      {
        role: "Người vận hành cộng đồng",
        context: "Cộng đồng kinh doanh toàn cầu",
        quote:
          "Đây là một công cụ phù hợp mạnh mẽ cho các cộng đồng tập trung vào xuất khẩu, sourcing và bán hàng quốc tế.",
      },
    ],
  },
  proof: {
    eyebrow: "Lý do bạn có thể tự tin giới thiệu TradeIt",
    title: "Dựa trên dữ liệu, được sử dụng trên toàn cầu",
    subtitle:
      "TradeIt kết hợp cơ sở dữ liệu thương mại toàn cầu quy mô lớn, dữ liệu liên hệ B2B đã được xác thực và các insight được hỗ trợ bởi AI để giúp doanh nghiệp bán hàng quốc tế hiệu quả hơn.",
    stats: [
      {
        value: "8B+",
        label: "bản ghi thương mại",
        body: "Truy cập một trong những cơ sở dữ liệu tình báo thương mại toàn cầu có quy mô lớn.",
      },
      {
        value: "200+",
        label: "quốc gia và khu vực",
        body: "Khám phá dữ liệu xuất nhập khẩu từ các thị trường trên toàn thế giới.",
      },
      {
        value: "230M+",
        label: "công ty và liên hệ đã xác thực",
        body: "Tiếp cận người ra quyết định thông qua cơ sở dữ liệu liên hệ B2B toàn cầu.",
      },
    ],
    badges: [
      "Phân tích người mua bằng AI",
      "Tình báo thương mại toàn cầu",
      "Liên hệ B2B đã xác thực",
      "CRM và quản lý bán hàng",
    ],
  },
  cta: {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Những sản phẩm nào được tính hoa hồng?",
        a: "Tất cả các gói đăng ký trả phí của TradeIt đều được tính hoa hồng, trừ khi có thông báo khác.",
      },
      {
  ...
  footer: {
    ...
    rights: "© 2026 TradeIt. All rights reserved.",
  },
};
