...
const faqs = [
  ...
  },
  {
    ...
    a: "As a TradeIt affiliate partner, you must promote TradeIt in a fair, accurate, and ethical manner. Certain promotional activities are strictly prohibited. Please take note of the following key restrictions:\n\nFraudulent Activities:\nYou are not allowed to engage in fraudulent activities, including but not limited to click fraud, fake sign-ups, self-referrals, cookie stuffing, unauthorized tracking manipulation, or any other activity intended to artificially generate commissions.\n\nMisleading or False Claims:\nYou must not misrepresent TradeIt, its services, features, pricing, data coverage, or expected results. Affiliates may not make false claims, guarantee sales outcomes, present unavailable offers, or use deceptive marketing tactics.\n\nUnauthorized Paid Advertising:\nPaid advertising campaigns using TradeIt-related keywords, brand terms, or misspelled brand terms must receive prior approval from the TradeIt team. Affiliates are not allowed to bid on TradeIt branded keywords, use misleading ad copy, directly link paid ads to TradeIt without approval, or engage in ad hijacking.\n\nRestricted Promotion Channels:\nYou may not promote TradeIt on adult websites, gambling platforms, hate speech websites, violent or illegal content platforms, or any channels that may damage TradeIt’s brand reputation. Promotion through low-quality, deceptive, or unauthorized traffic sources is also prohibited.\n\nSpam and Unauthorized Outreach:\nAffiliates must not send promotional emails, messages, or campaigns to people who have not given permission to be contacted. Spam, mass unsolicited outreach, and the use of purchased or unauthorized contact lists are strictly prohibited.\n\nUnauthorized Use of TradeIt Brand Assets:\nYou may not use TradeIt’s trademarks, logos, brand name, or similar variations in domain names, social media accounts, community names, paid ads, or misleading promotional materials without prior written approval.\n\nProhibited Incentives or Discount Claims:\nAffiliates may not advertise unauthorized discounts, coupons, free trials, bonuses, or special offers unless they have been officially approved by TradeIt.\n\nPlease carefully review and follow the TradeIt Affiliate Partners Program Terms and Conditions to ensure compliance with all program rules and promotional guidelines. Violations may result in rejected commissions, suspension, or termination of your partner account.",
  },
  {
