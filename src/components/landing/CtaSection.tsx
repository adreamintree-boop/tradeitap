        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2 max-w-[340px] mx-auto sm:mt-8 sm:gap-3 sm:max-w-none">
            {badges.map((b) => (
              <span
                key={b}
                className="rounded-full border border-foreground/10 bg-background/70 px-3 py-[9px] text-[12px] font-semibold text-foreground backdrop-blur sm:px-4 sm:py-2 sm:text-sm"
              >
                {b}
              </span>
            ))}
